...
public class QuickCommandFeature {
    ...
    public static void onKeyInput(InputEvent.Key event) {
        ...
        if (mc == null || !cfg.enabled || mc.player == null || mc.f_91073_ == null) {
            return;
        }
        if (mc.screen != null) {
            return;
        }
        boolean shift = GLFW.glfwGetKey(mc.getWindow().m_85439_(), 340) == 1 || GLFW.glfwGetKey(mc.getWindow().m_85439_(), 344) == 1;
        boolean ctrl = GLFW.glfwGetKey(mc.getWindow().m_85439_(), 341) == 1 || GLFW.glfwGetKey(mc.getWindow().m_85439_(), 345) == 1;
        boolean alt = GLFW.glfwGetKey(mc.getWindow().m_85439_(), 342) == 1 || GLFW.glfwGetKey(mc.getWindow().m_85439_(), 346) == 1;
        ...
        for (int i = 0; i < cfg.commands.size(); ++i) {
            ...
            mc.player.f_108617_.m_246623_(rawCmd);
