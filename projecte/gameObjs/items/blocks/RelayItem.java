...
public class RelayItem extends BlockItem {
   ...
   public void m_7373_(@NotNull ItemStack stack, @Nullable Level level, @NotNull List tooltips, @NotNull TooltipFlag flags) {
      ...
      if (ProjectEConfig.client.statToolTips.get()) {
         tooltips.add(PELang.EMC_MAX_OUTPUT_RATE.translateColored(ChatFormatting.DARK_PURPLE, new Object[]{ChatFormatting.BLUE, Constants.EMC_FORMATTER.format(this.tier.getChargeRate())}));
         tooltips.add(PELang.EMC_MAX_STORAGE.translateColored(ChatFormatting.DARK_PURPLE, new Object[]{ChatFormatting.BLUE, Constants.EMC_FORMATTER.format(this.tier.getStorage())}));
      }
