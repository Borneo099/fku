...
public class RMArmor extends PEArmor {
   public RMArmor(ArmorItem.Type armorType, Item.Properties props) {
      super(RMArmor.RMArmorMaterial.INSTANCE, armorType, props);
   }
