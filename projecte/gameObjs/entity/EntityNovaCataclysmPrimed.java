...
public class EntityNovaCataclysmPrimed extends PrimedTnt {
   public EntityNovaCataclysmPrimed(EntityType type, Level level) {
      super(type, level);
   ...
   public @NotNull EntityType m_6095_() {
      return (EntityType)PEEntityTypes.NOVA_CATACLYSM_PRIMED.get();
   }

   protected void m_32103_() {
      WorldHelper.createNovaExplosion(this.m_9236_(), this, this.m_20185_(), this.m_20186_(), this.m_20189_(), 48.0F);
   }
