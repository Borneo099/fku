...
public enum PELang implements ILangEntry {
   ...
   private PELang(String type, String path) {
      this(Util.m_137492_(type, PECore.rl(path)));
   }

   private PELang(String key) {
      this.key = key;
   }
   ...
   // $FF: synthetic method
   private static PELang[] $values() {
      return new PELang[]{UNKNOWN_ITEM, UNKNOWN_TAG, PROJECTE, PACK_DESCRIPTION, SECONDS, EVERY_TICK, HIGH_ALCHEMIST, UPDATE_AVAILABLE, UPDATE_GET_IT, BLACKLIST, WHITELIST, DENSITY_MODE_TARGET, CLEAR_KNOWLEDGE_NOTIFY, CLEAR_KNOWLEDGE_SUCCESS, DUMP_MISSING_EMC_NONE_MISSING, DUMP_MISSING_EMC_ONE_MISSING, DUMP_MISSING_EMC_MULTIPLE_MISSING, COMMAND_INVALID_ITEM, COMMAND_NO_ITEM, COMMAND_REMOVE_SUCCESS, COMMAND_RESET_SUCCESS, COMMAND_SET_SUCCESS, COMMAND_EMC_INVALID, COMMAND_EMC_NEGATIVE, COMMAND_EMC_ADD_SUCCESS, COMMAND_EMC_REMOVE_SUCCESS, COMMAND_EMC_SET_SUCCESS, COMMAND_EMC_GET_SUCCESS, COMMAND_EMC_TEST_SUCCESS, COMMAND_EMC_TEST_FAIL, COMMAND_KNOWLEDGE_INVALID, COMMAND_KNOWLEDGE_CLEAR_SUCCESS, COMMAND_KNOWLEDGE_CLEAR_FAIL, COMMAND_KNOWLEDGE_LEARN_SUCCESS, COMMAND_KNOWLEDGE_LEARN_FAIL, COMMAND_KNOWLEDGE_UNLEARN_SUCCESS, COMMAND_KNOWLEDGE_UNLEARN_FAIL, COMMAND_KNOWLEDGE_TEST_SUCCESS, COMMAND_KNOWLEDGE_TEST_FAIL, COMMAND_PROVIDER_FAIL, RELOAD_NOTICE, SHOWBAG_NOT_FOUND, SHOWBAG_NAMED, DIVINING_AVG_EMC, DIVINING_MAX_EMC, DIVINING_SECOND_MAX, DIVINING_THIRD_MAX, DIVINING_RANGE_3, DIVINING_RANGE_16, DIVINING_RANGE_64, EMC, EMC_MAX_GEN_RATE, EMC_MAX_OUTPUT_RATE, EMC_MAX_STORAGE, EMC_STORED, EMC_HAS_KNOWLEDGE, EMC_NO_KNOWLEDGE, EMC_TOOLTIP, EMC_STACK_TOOLTIP, EMC_TOOLTIP_WITH_SELL, EMC_STACK_TOOLTIP_WITH_SELL, EMC_TOO_MUCH, JEI_COLLECTOR, WORLD_TRANSMUTE, WORLD_TRANSMUTE_DESCRIPTION, CURIOS_KLEIN_STAR, GEM_ENABLED, GEM_DISABLED, GEM_ACTIVATE, GEM_DEACTIVATE, NIGHT_VISION, NIGHT_VISION_PROMPT, STEP_ASSIST, STEP_ASSIST_PROMPT, GEM_LORE_FEET, GEM_LORE_LEGS, GEM_LORE_CHEST, GEM_LORE_HELM, GUI_DARK_MATTER_FURNACE, GUI_RED_MATTER_FURNACE, GUI_RELAY_MK1, GUI_RELAY_MK2, GUI_RELAY_MK3, CURRENT_MODE, INVALID_MODE, MODE_SWITCH, MODE_ARCANA_1, MODE_ARCANA_2, MODE_ARCANA_3, MODE_ARCANA_4, MODE_KATAR_1, MODE_KATAR_2, MODE_MERCURIAL_EYE_1, MODE_MERCURIAL_EYE_2, MODE_MERCURIAL_EYE_3, MODE_MERCURIAL_EYE_4, MODE_MERCURIAL_EYE_5, MODE_MERCURIAL_EYE_6, MODE_MORNING_STAR_1, MODE_MORNING_STAR_2, MODE_MORNING_STAR_3, MODE_MORNING_STAR_4, MODE_PHILOSOPHER_1, MODE_PHILOSOPHER_2, MODE_PHILOSOPHER_3, MODE_PICK_1, MODE_PICK_2, MODE_PICK_3, MODE_PICK_4, MODE_RED_SWORD_1, MODE_RED_SWORD_2, PEDESTAL_DISABLED, PEDESTAL_ON, PEDESTAL_TOOLTIP1, PEDESTAL_TOOLTIP2, PEDESTAL_ARCHANGEL_1, PEDESTAL_ARCHANGEL_2, PEDESTAL_BLACK_HOLE_BAND_1, PEDESTAL_BLACK_HOLE_BAND_2, PEDESTAL_BODY_STONE_1, PEDESTAL_BODY_STONE_2, PEDESTAL_EVERTIDE_1, PEDESTAL_EVERTIDE_2, PEDESTAL_HARVEST_GODDESS_1, PEDESTAL_HARVEST_GODDESS_2, PEDESTAL_HARVEST_GODDESS_3, PEDESTAL_IGNITION_1, PEDESTAL_IGNITION_2, PEDESTAL_LIFE_STONE_1, PEDESTAL_LIFE_STONE_2, PEDESTAL_MIND_STONE, PEDESTAL_REPAIR_TALISMAN_1, PEDESTAL_REPAIR_TALISMAN_2, PEDESTAL_SOUL_STONE_1, PEDESTAL_SOUL_STONE_2, PEDESTAL_SWRG_1, PEDESTAL_SWRG_2, PEDESTAL_TIME_WATCH_1, PEDESTAL_TIME_WATCH_2, PEDESTAL_VOLCANITE_1, PEDESTAL_VOLCANITE_2, PEDESTAL_ZERO_1, PEDESTAL_ZERO_2, PEDESTAL_ZERO_3, TIME_WATCH_DISABLED, TIME_WATCH_MODE, TIME_WATCH_MODE_SWITCH, TIME_WATCH_OFF, TIME_WATCH_FAST_FORWARD, TIME_WATCH_REWIND, TOOLTIP_ARCANA_INACTIVE, TOOLTIP_EVERTIDE_1, TOOLTIP_EVERTIDE_2, TOOLTIP_EVERTIDE_3, TOOLTIP_EVERTIDE_4, TOOLTIP_GEM_DENSITY_1, TOOLTIP_GEM_DENSITY_2, TOOLTIP_GEM_DENSITY_3, TOOLTIP_GEM_DENSITY_4, TOOLTIP_GEM_DENSITY_5, TOOLTIP_PHILOSTONE, TOOLTIP_STORED_XP, TOOLTIP_TIME_WATCH_1, TOOLTIP_TIME_WATCH_2, TOOLTIP_TOME, TOOLTIP_VOLCANITE_1, TOOLTIP_VOLCANITE_2, TOOLTIP_VOLCANITE_3, TOOLTIP_VOLCANITE_4, TRANSMUTATION_TRANSMUTE, TRANSMUTATION_LEARNED_1, TRANSMUTATION_LEARNED_2, TRANSMUTATION_LEARNED_3, TRANSMUTATION_LEARNED_4, TRANSMUTATION_LEARNED_5, TRANSMUTATION_LEARNED_6, TRANSMUTATION_LEARNED_7, TRANSMUTATION_LEARNED_8, TRANSMUTATION_UNLEARNED_1, TRANSMUTATION_UNLEARNED_2, TRANSMUTATION_UNLEARNED_3, TRANSMUTATION_UNLEARNED_4, TRANSMUTATION_UNLEARNED_5, TRANSMUTATION_UNLEARNED_6, TRANSMUTATION_UNLEARNED_7, TRANSMUTATION_UNLEARNED_8, TRANSMUTATION_UNLEARNED_9, ADVANCEMENTS_PROJECTE_DESCRIPTION, ADVANCEMENTS_PHILO_STONE, ADVANCEMENTS_PHILO_STONE_DESCRIPTION, ADVANCEMENTS_TRANSMUTATION_TABLE, ADVANCEMENTS_TRANSMUTATION_TABLE_DESCRIPTION, ADVANCEMENTS_TRANSMUTATION_TABLET, ADVANCEMENTS_TRANSMUTATION_TABLET_DESCRIPTION, ADVANCEMENTS_KLEIN_STAR, ADVANCEMENTS_KLEIN_STAR_DESCRIPTION, ADVANCEMENTS_KLEIN_STAR_BIG, ADVANCEMENTS_KLEIN_STAR_BIG_DESCRIPTION, ADVANCEMENTS_ALCH_CHEST, ADVANCEMENTS_ALCH_CHEST_DESCRIPTION, ADVANCEMENTS_ALCH_BAG, ADVANCEMENTS_ALCH_BAG_DESCRIPTION, ADVANCEMENTS_CONDENSER, ADVANCEMENTS_CONDENSER_DESCRIPTION, ADVANCEMENTS_COLLECTOR, ADVANCEMENTS_COLLECTOR_DESCRIPTION, ADVANCEMENTS_RELAY, ADVANCEMENTS_RELAY_DESCRIPTION, ADVANCEMENTS_DARK_MATTER, ADVANCEMENTS_DARK_MATTER_DESCRIPTION, ADVANCEMENTS_DARK_MATTER_PICKAXE, ADVANCEMENTS_DARK_MATTER_PICKAXE_DESCRIPTION, ADVANCEMENTS_DARK_MATTER_BLOCK, ADVANCEMENTS_DARK_MATTER_BLOCK_DESCRIPTION, ADVANCEMENTS_DARK_MATTER_FURNACE, ADVANCEMENTS_DARK_MATTER_FURNACE_DESCRIPTION, ADVANCEMENTS_RED_MATTER, ADVANCEMENTS_RED_MATTER_DESCRIPTION, ADVANCEMENTS_RED_MATTER_PICKAXE, ADVANCEMENTS_RED_MATTER_PICKAXE_DESCRIPTION, ADVANCEMENTS_RED_MATTER_BLOCK, ADVANCEMENTS_RED_MATTER_BLOCK_DESCRIPTION, ADVANCEMENTS_RED_MATTER_FURNACE, ADVANCEMENTS_RED_MATTER_FURNACE_DESCRIPTION};
   }
}
